...
urlpatterns = [
    ...
    path(
        "teacher-register/", TeacherRegisterationView.as_view(), name="Teacher_Register"
    ),
    path(
        "student-register/", StudentRegisterationView.as_view(), name="Student_Register"
    ),
    ...
    path(
        "reset/<uid>/<token>/", UserPasswordResetView.as_view(), name="reset-password"
    ),
]
